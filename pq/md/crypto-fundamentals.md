...
This file answers both. It is intentionally non-implementation — for protocol/algorithm specifics see [`algorithms-and-protocols.md`](algorithms-and-protocols.md), [`component-architecture.md`](component-architecture.md), and [`../pq-migration.md`](../pq-migration.md).
...
- [`algorithms-and-protocols.md`](algorithms-and-protocols.md) — algorithm/protocol catalog with wrap/unwrap sequence diagrams
- [`component-architecture.md`](component-architecture.md) — 12-component architecture and the three goals (A: hybrid KEM, B: SPQR+PQXDH, C: PQ-MLS)
- [`native-dependencies.md`](native-dependencies.md) — why mlkem-native over liboqs
- [`pqxdh-spqr-deep-dive.md`](pqxdh-spqr-deep-dive.md) — Goal B deep dive: threat model, prekey bundles, ratchet state, wire formats
