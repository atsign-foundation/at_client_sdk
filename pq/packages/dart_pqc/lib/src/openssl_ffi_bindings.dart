...
// EVP_PKEY_get_octet_string_param — extract raw ML-KEM SK / PK bytes
typedef EvpPkeyGetOctetStringParamNative = Int32 Function(
    Pointer<EVP_PKEY>, Pointer<Utf8>, Pointer<Uint8>, IntPtr, Pointer<IntPtr>);
typedef EvpPkeyGetOctetStringParamDart = int Function(
    Pointer<EVP_PKEY>, Pointer<Utf8>, Pointer<Uint8>, int, Pointer<IntPtr>);

// EVP_PKEY_CTX_set_params — pass seed/params to keygen (e.g. ML-KEM deterministic keygen)
...
// EVP_Q_digest — one-shot hash (SHA3-256 used by X-Wing combiner)
typedef EvpQDigestNative = Int32 Function(Pointer<Void>, Pointer<Utf8>,
    Pointer<Utf8>, Pointer<Uint8>, IntPtr, Pointer<Uint8>, Pointer<IntPtr>);
typedef EvpQDigestDart = int Function(Pointer<Void>, Pointer<Utf8>,
    Pointer<Utf8>, Pointer<Uint8>, int, Pointer<Uint8>, Pointer<IntPtr>);

// EVP_DigestSignInit_ex / EVP_DigestVerifyInit_ex — 7-arg variants for ML-DSA-65
// (Ed25519 uses the 5-arg EVP_DigestSignInit / EVP_DigestVerifyInit above)
typedef EvpDigestSignInitExNative = Int32 Function(
    Pointer<Void>,
    ...
    Pointer<EVP_PKEY>,
    Pointer<Void>);
typedef EvpDigestSignInitExDart = int Function(
    Pointer<Void>,
    Pointer<Pointer<EVP_PKEY_CTX>>,
    Pointer<Utf8>,
    Pointer<Utf8>,
...
typedef EvpDigestVerifyInitExNative = Int32 Function(
    Pointer<Void>,
    Pointer<Pointer<EVP_PKEY_CTX>>,
    Pointer<Utf8>,
    Pointer<Utf8>,
    ...
    Pointer<EVP_PKEY>,
    Pointer<Void>);
typedef EvpDigestVerifyInitExDart = int Function(
    Pointer<Void>,
    Pointer<Pointer<EVP_PKEY_CTX>>,
    Pointer<Utf8>,
    Pointer<Utf8>,
