...
**63 rows** — the catalogue's 53 use cases become 53 scenarios (UC-A5.1 splits
...
| B5 · edge cases               | B5.1 ✅, B5.2 ✅, B5.3 ✅, B5.4 ✅, B5.5 ✅, B5.6 ✅, B5.7 ✅, B5.8 ✅, B5.9 ✅, B5.10 ✅, B5.11 ✅, B5.12 ✅ | — |
| C1 · rollout by flags         | C1.1 ✅, C1.2 ✅, C1.4 ✅, C1.5 ✅, C1.6 ✅, C1.7 ✅ | — |
| cross-cutting invariants      | 10 (10 ✅)                        | —            |

**UC-C1.3 is withdrawn**, which is why 53 use cases yield 53 scenarios rather
...
**2 of the 63** rows are skipped, and the burn-down went back above zero on
