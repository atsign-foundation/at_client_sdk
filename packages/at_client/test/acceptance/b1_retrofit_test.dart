...
void main() {
  group('B1 · retrofit an existing atSign', () {
    ...
    test('UC-B1.2 · second install on a copied keyfile (alice1c)', () {
      // GIVEN after B1.1; pqpublickey exists; alice1c is a clone of E1's pre-PQ
      //       keyfile.
      ...
      //       under E1), then requests the pqpublickey private, verifies
