...
void main() {
  group('B5 · retrofit edge cases', () {
    test('UC-B5.1 · offline enrollment pulls pqpublickey later', () {
      // GIVEN alice2 was offline during the retrofit wave; pqpublickey was
      //       created by alice1.
      // WHEN  alice2 next comes online and retrofits.
      // THEN  pqpublickey is root (no namespace) so it has NO enroll:listns
    ...
    test('UC-B5.3 · two enrollments race to create pqpublickey', () {
      // GIVEN alice1 and alice3 both reach the create step with pqpublickey
      //       absent.
