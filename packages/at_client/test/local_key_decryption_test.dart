  ...
  group('A group of local key decryption tests', () {
    test('test to verify decryption of local key', () async {
      ...
      var encryptedSharedSymmetricKey = EncryptionUtil.encryptKey(
        sharedSymmetricKey,
        rsaKeyPair.atPublicKey.publicKey,
      );
      ...
      var encryptedTestValue = EncryptionUtil.encryptValue(
        testValue,
        sharedSymmetricKey,
      );
      var localKeyDecryption = LocalKeyDecryption(mockAtClient);
      var decryptedTestValue = await localKeyDecryption.decrypt(
        localKey,
        encryptedTestValue,
      );
