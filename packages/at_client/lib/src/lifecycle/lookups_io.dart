...
/// The atDirectory lookup a client uses when its application supplied no
/// [SecondaryAddressFinder]: the preference's root, over TLS.
SecondaryAddressFinder defaultSecondaryAddressFinder(
        AtClientPreference preference) =>
    CacheableSecondaryAddressFinder(preference.rootDomain, preference.rootPort);
