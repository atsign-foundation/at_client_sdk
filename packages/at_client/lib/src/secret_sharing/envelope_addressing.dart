...
///
/// [inReplyTo] orders an answer against the request that asked for it, and is
/// [unsolicited] on anything that answers nothing.
///
...
/// kpid-then-marker pair, so a segment ahead of it is invisible to every one of
/// them.
class EnvelopeAddressing {
  ...
  ///
  /// [inReplyTo] is [unsolicited] for a request or a push.
  ///
  ...
  /// nothing or, spelled carelessly, match every envelope on the atServer.
  ...
  /// request [requestId].
  ///
  /// Narrower than [sweepRegexFor], which matches every envelope at an address
  /// whether it answers anything or not.
