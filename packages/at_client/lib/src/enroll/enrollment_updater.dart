...
import 'package:at_auth/at_auth.dart'
    show AtEnrollmentResponse, apkamPossessionSignature, apskAdvertisement;
...
///
/// Self-only: the approving side's verbs need a connection holding `__manage`
/// and act on *somebody else's* enrollment; this one needs no privilege at
/// all and can only ever act on the enrollment the connection is
/// authenticated as. The atServer enforces exactly that, refusing an owner
/// connection rather than waving it through.
