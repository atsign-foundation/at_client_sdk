...
/// The EnrollmentRequest class encapsulates the fields shared between the
/// [FirstEnrollmentRequest] and the [AtEnrollmentRequest].
///
...
///
/// The [AtEnrollmentRequest] is used by the other apps to authenticate. This request is sent to the server and subsequently
...
///     session: session, // atsign + rootDomain + the atKeysIo to persist into
///     appName: 'wavi',
///     deviceName: 'iphone',
...
class FirstEnrollmentRequest extends EnrollmentRequest {
  ...
  /// The APKAM public key the server registers for this enrollment. Onboarding
  /// mints the keyset (`AtKeys.generate`) and holds the private half; only the
  /// public key goes on the request.
