...
void main() {
  group('KeyAlgorithmType tripwire', () {
    test('existing token values never change', () {
      ...
      expect(KeyAlgorithmType.mlKem1024, 'mlkem1024');
  ...
  group('CryptographicKeyType tripwire', () {
    test('existing token values never change', () {
      ...
      expect(
          CryptographicKeyType.privateAuthentication, 'privateAuthentication');
      expect(CryptographicKeyType.publicAuthentication, 'publicAuthentication');
    });
