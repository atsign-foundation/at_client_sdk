...
void main() {
  ...
  group('AtKeysPassphraseEnvelopeCodec', () {
    const codec = password_envelope.AtKeysPassphraseEnvelopeCodec();

    Future<Map<String, dynamic>> envelopeFor(String plaintext) async {
      final envelope =
          await password_envelope.AtKeysCrypto.fromHashingAlgorithm(
        HashingAlgoType.argon2id,
    ...
    test('throws when the decrypted payload is not a JSON object', () async {
