...
#include <at_backupkey_flutter/at_backupkey_flutter_plugin.h>
#include <at_file_saver/file_saver_plugin.h>
#include <biometric_storage/biometric_storage_plugin.h>
#include <url_launcher_linux/url_launcher_plugin.h>

void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) at_backupkey_flutter_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "AtBackupkeyFlutterPlugin");
  at_backupkey_flutter_plugin_register_with_registrar(at_backupkey_flutter_registrar);
