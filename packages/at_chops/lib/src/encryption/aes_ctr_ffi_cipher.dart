...
final class AesCtrFfiCipher {
  ...
  /// Creates a cipher over [key] starting from counter block [iv].
  ///
  /// [key] must be 16, 24 or 32 bytes and [iv] exactly [ivLength] bytes.
  ...
  factory AesCtrFfiCipher.fromLib(
      DynamicLibrary lib, Uint8List key, InitialisationVector iv) {
    final Uint8List keyBytes = key;
