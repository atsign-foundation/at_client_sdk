...
final class AesGcm256FfiAlgo implements SymmetricEncryptionAlgorithm {
  ...
  // The key and nonce lengths are validated before any bytes reach native
  // code: OpenSSL reads a fixed 32-byte key and 12-byte IV out of the buffers
  // we size from these inputs, so a short one would be a heap over-read.
