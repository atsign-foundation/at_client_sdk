...
final signature = await MlDsa65PureDartAlgo.instance.signBytes(message, kp.secretKey);
final valid = await MlDsa65PureDartAlgo.instance.verifyBytes(message, signature, kp.publicKey);
```
