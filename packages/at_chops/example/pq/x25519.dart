...
Future<void> main() async {
  final X25519PureDartAlgo x25519pureDartAlgo = X25519PureDartAlgo.instance;
  ...
  final Uint8List aliceSharedSecret = await x25519pureDartAlgo.dh(x25519PrivateKeyBytes1, x25519PublicKeyBytes2);
  final Uint8List bobSharedSecret = await x25519pureDartAlgo.dh(x25519PrivateKeyBytes2, x25519PublicKeyBytes1);
