...
///
/// Carried as a zone value, so a socket [connectTls] opens anywhere inside
/// [run] belongs to it, even one opened by code that knows nothing of its
/// owner, such as a shared atDirectory finder.
class Abandonment {
