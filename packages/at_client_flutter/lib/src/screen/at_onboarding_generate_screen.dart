...
import 'package:at_client_flutter/at_client_flutter.dart' show AtRootDomain;
...
import 'package:at_client_flutter/src/screen/at_onboarding_home_screen.dart';
import 'package:at_client_flutter/src/screen/at_onboarding_pair_screen.dart';
...
class _AtOnboardingGenerateScreenState
  ...
  void _getFreeAtsign() async {
    ...
    dynamic data;
    String? atsign;
    dynamic response = await _onboardingUtil.getFreeAtSigns();
  ...
  Future<void> _processSharedSecret({
    ...
    try {
      ...
      var request = AtOnboardingRequest(verifiedAtSign)
        ..rootDomain = AtRootDomain(
          _onboardingService.getAtClientPreference()?.rootDomain ??
              "root.atsign.org",
          _onboardingService.getAtClientPreference()?.rootPort ?? 64,
        );
