...
//   late AtAuthService mockAtAuthService;
...
//     mockAtAuthService = MockAtAuthService();
...
//       AtKeys atKeys = AtKeys.fromJson(jsonData);
//       when(() => mockKeyChainManager.getPkamPrivateKey(any()))
//           .thenAnswer((_) => Future.value('dummy_private_key'));

//       var atAuthService =
//           AtClientMobile.authService(atSign, atClientPreference);
//       var atAuthRequest = AtAuthRequest(atSign)..atAuthKeys = atKeys;
//       var authResult = await atAuthService.authenticate(atAuthRequest);
...
//       var atAuthService = AtClientMobile.authService(atSign, atClientPreference);
//       var apkamPrivateKey = await mockKeyChainManager.getPkamPrivateKey(atSign);
...
//       var atClientService = AtClientMobile.authService(atSign, atClientPreference);
