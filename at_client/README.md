...
Initially to get a basic overview of the SDK, you must read the [atsign docs](https://docs.atsign.com/sdk/).

> To use this package you must have a basic setup. Follow the instructions here to [get started](https://docs.atsign.com/start/flutter/#3-install-at_app).
...
AtClient has many more methods that are exposed. Please refer to the [atsign docs](https://docs.atsign.com/sdk/flutter/introduction/) for more details.
