...
void main() {
  ...
  test(
    ...
    var remoteSecondary =
        RemoteSecondary(atSign, preference, useWebSocket: true);
  ...
  test(
   ...
   test(
      'Verify the update and llookup using execute command functionality over a socket connection by passing useWebSocket as false',
      () async {
    final atClient = atClientManager.atClient;
    final atChopsKeys = AtChopsKeys.create(
        null,
    ...
    atClient.atChops = atChops;
    var preference = TestUtils.getPreference(atSign);
    // create remote secondary Instance with useWebsocket false
    var remoteSecondary =
        RemoteSecondary(atSign, preference, useWebSocket: false);
