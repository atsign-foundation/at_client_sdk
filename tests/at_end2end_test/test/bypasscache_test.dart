...
void main() {
  ...
  test('bypass cache test', () async {
    ...
    var putResult = await currentAtSignClientManager?.atClient
        .put(verificationKey, oldValue);
    ...
    var configResult = await currentAtSignClientManager?.atClient
        .getRemoteSecondary()!
    ...
    var verificationKeyNew = AtKey()
      ...
      ..sharedWith = sharedWithAtSign;
    var newValue = '9900';
    var newPutResult = await currentAtSignClientManager?.atClient
    ...
    // adding a delay
    await Future.delayed(Duration(seconds: 3));
    var getResultWithFalse = await sharedWithAtSignClientManager?.atClient.get(
        getKey,
