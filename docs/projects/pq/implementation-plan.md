...
| **G8** | **YES** — and it is the newest entry, added 2026-08-25 |
...
**G8. Stop the short-lived lock records from growing the commit log.** Asked for
by gkc, 2026-08-25. ⚠️ **Whether this gates D1 is his call and he has not said**
— it is recorded here because he asked for it next, not because it is a gate.
