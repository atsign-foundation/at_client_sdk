...
matrix is the logical place to build that out. Measured 2026-08-23: **180** live
test declarations across 65 files (the matcher is in G2's `## TODO` row — a
looser one gives 225), only **29 of the 69** use-case ids nameable
