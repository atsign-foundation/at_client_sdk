...
| ---- | ---: | ---------- |
| [the partial clauses](detail/acceptance.md#the-partial-clauses--objective-1s-remaining-work) | 30 | a test exercises the clause and does not establish it as written. **1 is in-process and needs no virtualenv**; 29 are live and are the only route that raises server-proven. ⚠️ **Read the array-shape warning above before writing a test for any of them** — three of the six examined on 2026-08-27 were superseded clauses rather than test gaps |
