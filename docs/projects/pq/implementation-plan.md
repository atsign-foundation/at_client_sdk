...
That was the reading on 2026-08-26: nothing else in the workspace's
deprecation debt was D1 work, buckets A, C and E got no `// ignore:` yet, and D
waited for v5. **gkc ruled on 2026-09-11 that the whole debt gates
publication**; the list is now
[`docs/projects/deprecations/plan.md`](../deprecations/plan.md) and this section
keeps the ladder's history. Re-derive before starting
