...
⚠️ **Rows A1, A2, A3, B2, B1, B3, B4, B5 and D2 are built (2026-08-14) — all
of ruling 99, plus ruling 98's `_apsk` rule, its stage definitions and both of
its minting sites. Still unbuilt: C1, C2, D1.**
