...
([decisions.md 20](detail/decisions.md#20-ss-2-how-the-key-package-reaches-an-enrollment-and-how-conveyance-fires-2026-08-03)
ruling 10).
...
⚠️ **Re-scoped by [decisions.md 21](detail/decisions.md#21-ss-3-where-key-material-lives-and-what-the-substrate-stops-storing-2026-08-03), which shrank this rather than growing it.** Three of the
...
⚠️ **Re-scoped by [decisions.md 22](detail/decisions.md#22-ss-4-when-a-namespace-key-is-minted-and-what-must-be-true-first-2026-08-03).** Read that first; the deliverables below
predate it and describe `pqpublickey` as a KEM, which [decisions.md 18](detail/decisions.md#18-pqpublickey-becomes-the-user-owned-signing-root-2026-08-03) already replaced.
...
- ~~chain **verification** — walk `_apsk` to `_apsk` up to the root~~ — **ruled and built**
  ([decisions.md 24](detail/decisions.md#24-how-the-approval-chain-terminates-at-the-root-2026-08-04)).
...
- **key-transparency publication mechanics** — when a root is submitted, and what a client does if
  the log is unreachable at mint. Still un-grilled, and [decisions.md 24](detail/decisions.md#244-built-since-and-what-is-still-owed)
...
### B-1 — at/nskey + at/symmetric/AES/GCM providers + cold-start · at_client · XL *(title's former "capability marker, negotiation" scope removed by [decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05))*
...
- **Layer 3 — `at/symmetric/AES/GCM`:** AES-256-GCM under a symmetric CK cited by `ckKid`;
  ...
  the CK lives ([decisions.md 19](detail/decisions.md#19-nested-namespaces-the-nskey-is-resolved-by-walking-up-2026-08-03)).
...
- **B3 capability marker:** *(REMOVED by
  [decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05)
...
announcement ([decisions.md 26](detail/decisions.md#26-uc-a44-a-conveyance-that-loses-the-race-to-its-own-announcement-2026-08-04)).
...
| **D1 GA critical path, re-derived 2026-08-05 after the three-scenario re-examination** ([decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05)–[41](detail/decisions.md#41-the-to-define-list-2026-08-05)). **R-1 is DELIVERED, shrunk to D1-D**: `disallowLegacyEncryption` landed 2026-08-05; the marker/negotiation half was built, proven at three layers, and removed the same day; C3 deferred unbuilt. **Newly ON the GA path:** **SH-1** (M, key-material self-heal — the conveyance hole meant an enrollment created after a mint was stranded; in progress 2026-08-05) and **RF-SRV** (L, server self-enroll — every scenario's "upgrade the enrollment", was mis-filed off-path). **Re-timed:** ON-1 mints/publishes legacy material by default (decisions 37); R-2 keeps the flag flip but loses phase-4 stop-existing to a later ecosystem-gated release; B-3 phase 3's client-side stop likewise. Remaining on the GA path: **SH-1**, **RF-SRV**, **B-2** (L), **ON-1** (M), **R-2** (M), **S-3** (L). The to-define list ([decisions 41](detail/decisions.md#41-the-to-define-list-2026-08-05)) is the authoritative open-questions ledger — 12 items with owners; **all 12 ruled 2026-08-05** ([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05)), so the definitions now land in their owner projects as implementation | plan |
...
[decisions.md 19.4](detail/decisions.md#194-cost-and-the-three-lifetimes) removes the per-item
...
([decisions.md 19](detail/decisions.md#19-nested-namespaces-the-nskey-is-resolved-by-walking-up-2026-08-03)).
...
> ([decisions 40](detail/decisions.md#40-rf-srv-is-the-mechanism-the-whole-model-stands-on-2026-08-05)):
...
[decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 3, landed on the spike), so the
...
**2026-08-05 additions ([decisions 40](detail/decisions.md#40-rf-srv-is-the-mechanism-the-whole-model-stands-on-2026-08-05)):**
...
**Ruled 2026-08-05 ([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05)
...
**LANDED 2026-08-05** ([decisions 43](detail/decisions.md#43-rf-2b-lands-and-what-the-first-genuine-ml-dsa-pkam-found-2026-08-05)):
...
([decisions 37](detail/decisions.md#37-legacy-key-material-is-retained-until-the-ecosystem-is-pq-not-the-atsign-2026-08-05)).
...
**Effort:** L.
**LANDED 2026-08-05** ([decisions 44](detail/decisions.md#44-rf-2c-the-switch-over-and-what-it-cost-to-make-a-client-pq-2026-08-05)
for the switch-over, [45](detail/decisions.md#45-the-retrofit-rows-and-the-five-defects-the-first-end-to-end-run-found-2026-08-05)
...
impl-only getter — [decisions 58.2](detail/decisions.md#582-signingalgotype-comes-off-the-interface-the-key-material-answers)
...
not a delivery bug. See [decisions 44.3](detail/decisions.md#443-two-findings-from-the-live-run).)
...
**Builds on:** B-1.
**What happened to the rest** ([decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05)):
...
**coversD1:** D1-D. (D1-C's migration story is now [decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05)'s
...
[decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 11.
Live-proven in `nskey_self_heal_live_test.dart`.
**Goal:** make [decisions 38](detail/decisions.md#38-key-material-self-heals-mint-if-absent-else-pull-2026-08-05)'s
...
([decisions 38](detail/decisions.md#38-key-material-self-heals-mint-if-absent-else-pull-2026-08-05).3).
...
([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 11): the
...
**Landed** on `gkc-pq-d1-spike` ([decisions 47](detail/decisions.md#47-b-2-lands-two-levers-and-the-difference-between-excluding-and-revoking-2026-08-06)):
...
Implements four rulings from [decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05):
...
([decisions 50](detail/decisions.md#50-two-kems-by-configuration-one-construction-by-negotiation-2026-08-07)):
...
**Ruled → [decisions 68](detail/decisions.md#68-the-enrollment-record-stops-being-a-one-way-door-enrollupdatemetadata-2026-08-10)**
...
### ON-1 — PQ-native greenfield onboarding + legacy-interop opt-out · at_client, at_client_flutter · M — **ACCEPTANCE COMPLETE 2026-08-08** ([decisions 52](detail/decisions.md#52-on-1-a-greenfield-atsign-starts-where-a-retrofit-ends-2026-08-08))  *(critic gap — UC-A1.1; amended by decisions 37)*
...
named by [decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05)
...
([decisions 70](detail/decisions.md#70-workstream-a-capstone-releaseposture-the-five-flags-as-one-value-2026-08-10)).
...
[decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 10: the
...
C1.6 (the grouped posture); **C1.3 (envelope) is withdrawn** — [`decisions.md` 95](detail/decisions.md#95-the-envelope-keeps-one-shape-and-a-retained-key-says-so-2026-08-12) removed the axis it tested, written for R-2 by the capstone; plus legacy read still works (UC-B5.2);
...
([decisions 70.1](detail/decisions.md#701-the-review-harvest-the-postures-claims-corrected-two-consults-get-their-reds-2026-08-10)).
**▶ at_client 4.0.0.**
**Effort:** M.
...
| 7  | `at_client`         | minor `3.14.x → 3.15.x`       | S-2…B-2, KE-1 | `at_auth ^4.0.0`; `CryptoContext.keys`; nskey data path; rotation; the selectable KEM. **= D1 GA**. ⚠️ **3.13.0 and 3.14.0 both published 2026-07-17** so the GA slot has moved off 3.14.x; trunk is already 3.14.1. For compatibility purposes the baseline is **3.13.0** ([`decisions.md` §91.4](detail/decisions.md#914-what-is-released-and-therefore-what-must-still-be-read)) — re-derive the target minor at execution against pub.dev. ⚠️ **S-2's `CryptoContext.keys` (#2076) is on trunk but unreleased** — it merged after 3.14.0 published, so the next at_client release is the first that carries it. ⚠️ **gated on row 3** — this release cannot go out against an unpublished `at_chops 3.6.0`, and a published 3.5.0 does not discharge that gate |
| 8  | `at_client`         | **major `3.15.x → 4.0.0`**    | R-2        | default posture → `ReleasePosture.postQuantum()` (all five axes, [decisions 70](detail/decisions.md#70-workstream-a-capstone-releaseposture-the-five-flags-as-one-value-2026-08-10)); plus the normal major-version deprecation cleanup (orthogonal to the rollout, [decisions 56.4](detail/decisions.md#564-from-the-pq-projects-view-40-is-final-3x-with-different-flag-defaults)). *(selfEncryptionKey stop-existing moved to a later ecosystem-gated release, [decisions 37](detail/decisions.md#37-legacy-key-material-is-retained-until-the-ecosystem-is-pq-not-the-atsign-2026-08-05))* |
...
**Everything up to and including SS-3 is landed as of 2026-08-03** (SS-1c/SS-2/SS-3 on `gkc-pq-d1-spike`, plus [at_server#2739](https://github.com/atsign-foundation/at_server/pull/2739) for SS-3's server half — **corrected 2026-08-13 from #2736, which was closed as superseded and never merged**). **`SS-4`'s signing chain landed 2026-08-04** — mint, root-private conveyance, self-anchoring and the graded walk, all live-covered. **B-1 landed too, and R-1 was delivered 2026-08-05 as the flag alone** ([decisions 36](detail/decisions.md#36-the-rollout-is-the-apps-decision-capability-markers-built-examined-and-removed-2026-08-05)); **SH-1, RF-SRV's server half, RF-2b and RF-2c's switch-over all landed 2026-08-05** ([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05)–[44](detail/decisions.md#44-rf-2c-the-switch-over-and-what-it-cost-to-make-a-client-pq-2026-08-05)), and **B-2 landed 2026-08-06** ([decisions 47](detail/decisions.md#47-b-2-lands-two-levers-and-the-difference-between-excluding-and-revoking-2026-08-06)) with all four UC-A5.x rows green. **KE-1 landed 2026-08-07** ([decisions 50](detail/decisions.md#50-two-kems-by-configuration-one-construction-by-negotiation-2026-08-07)) — the selectable KEM, the negotiated construction, and plan-backlog 14.2/14.4/14.5 discharged — so the path now waits on **ON-1**, **R-2** and **S-3**. RF-2c's UC-B1.x e2e rows are done; two named residuals are left: RF-SRV's revocation cascade (server) — `parentEnrollmentId` is stored but `enroll:revoke` does not yet walk descendants ([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 2) — the **at_chops 3.5.0 publish** that KE-1 put in front of the GA release, and a
...
| D1-B B7 (selfEncryptionKey retirement) | B-3 (phases 1-3); phase 4 = the later ecosystem-gated release ([decisions 37](detail/decisions.md#37-legacy-key-material-is-retained-until-the-ecosystem-is-pq-not-the-atsign-2026-08-05)), no longer R-2 |
...
[decisions 46](detail/decisions.md#46-rfc-9180-and-where-the-designs-version-hatches-are-2026-08-05)
and revisited in
[decisions 48](detail/decisions.md#48-the-standards-question-reopened-and-what-the-check-found-2026-08-06);
...
([decisions 50](detail/decisions.md#50-two-kems-by-configuration-one-construction-by-negotiation-2026-08-07));
**14.1**, ruled by **ON-1**
([decisions 52](detail/decisions.md#52-on-1-a-greenfield-atsign-starts-where-a-retrofit-ends-2026-08-08));
...
[decisions 101](detail/decisions.md#101-the-signing-root-becomes-an-ordinary-signing-key-and-rotatable-2026-08-15),
...
> ⛔ **SUPERSEDED 2026-08-15 by [decisions 101](detail/decisions.md#101-the-signing-root-becomes-an-ordinary-signing-key-and-rotatable-2026-08-15)
...
| Documented by [acceptance.md](acceptance.md) and [decisions 46.5](detail/decisions.md#465-the-signing-root-is-the-only-one-way-door) | `keys: [{"alg":"ml-dsa-65","pub":"<base64>"}]` |

`public:pq_signing_root@<atSign>` is an **immutable create-once** record that
never rotates ([decisions 18](detail/decisions.md#18-pqpublickey-becomes-the-user-owned-signing-root-2026-08-03)).
...
([decisions 48.8](detail/decisions.md#488-what-this-entry-does-not-rule)); the
...
**LANDED 2026-08-09** ([decisions 60](detail/decisions.md#60-jws-stage-one-lands-readers-always-on-producer-behind-the-version-flag-2026-08-09))
...
([`decisions.md` 103](detail/decisions.md#103-an-envelope-says-what-it-is-for-and-a-verifier-says-what-it-wants-2026-08-15)). Adjudicated by two third-party verifiers
...
[decisions 50.5](detail/decisions.md#505-the-defect-a-widened-list-planted-before-anything-read-it).
...
([decisions 48.9](detail/decisions.md#489-rfc-9180-landed-and-what-it-settled)).

### 14.6 The enrollment record's `metadata.keyPackage` is a one-way door

**Status: RESOLVED in design, PARTLY BUILT 2026-08-11. The door opens.** `enroll:update` ([`decisions.md` 91](detail/decisions.md#91-signature-agility-the-apkam-auth-key-stops-being-the-enrollments-signing-key-2026-08-11)
ruling 13, superseding `enroll:updateMetadata` in
[`decisions.md` 68](detail/decisions.md#68-the-enrollment-record-stops-being-a-one-way-door-enrollupdatemetadata-2026-08-10))
...
created. [decisions 46](detail/decisions.md#46-rfc-9180-and-where-the-designs-version-hatches-are-2026-08-05)
does not list it.

**Ruled 2026-08-10 — the door gets a handle, and the deadline goes with it**
([decisions 68](detail/decisions.md#68-the-enrollment-record-stops-being-a-one-way-door-enrollupdatemetadata-2026-08-10)).
...
([decisions 51](detail/decisions.md#51-the-from-challenge-and-a-signed-envelope-must-never-share-a-shape-2026-08-08)).
...
([decisions 42](detail/decisions.md#42-the-to-define-list-ruled-2026-08-05) item 2).
...
| 27 | ✅ **DONE 2026-08-15** — domain separation on the signed envelope, per-use `typ` plus a root-link prefix ([`decisions.md` 103](detail/decisions.md#103-an-envelope-says-what-it-is-for-and-a-verifier-says-what-it-wants-2026-08-15)) | [14.8](#148-domain-separation-on-the-signed-envelope) |
...
6. ~~**`_keyPackageHalves` can adopt a co-tenant's key package.**~~ **FIXED
   ...
   ([`decisions.md` 68.5](detail/decisions.md#685-the-receiver-becomes-multi-kpid)).
...
9. ~~**The one-live-enrollment invariant does not hold when the enrollment id
   ...
   ([`decisions.md` 91.3](detail/decisions.md#913-the-rulings) ruling 5). The fix is to
...
11. **An APKAM rotation that lands and is not persisted locks the enrollment
    ...
    ([`decisions.md` 97](detail/decisions.md#97-a-keyfile-status-a-build-has-never-seen-is-read-not-refused-2026-08-14)).
...
15. **An enrolled enrollment's `_apsk` has THREE writers, not one — and a
    ...
    **And it heals.** W2 composes from the keyfile, so its next invocation
    ...
    [`decisions.md` 102](detail/decisions.md#102-an-_apsk-fallback-value-never-replaces-a-real-advertisement-2026-08-15).**
...
18. **`MintLock` releases a lock it may no longer own — raised 2026-08-15,
    ...
    *successor's*, freshly taken by another enrollment. A third enrollment can
    ...
    [decisions 104.2](detail/decisions.md#1042-both-paths-already-heal-a-loser--by-different-moves).
    ⚠️ **The scope then changed underneath this item.**
    [decisions 104](detail/decisions.md#104-the-nskey-mint-stops-needing-a-winner-2026-08-16)
    ...
    **The shape gkc chose:** read the lock's value back and delete only if it
    ...
    ([decisions 104.9](detail/decisions.md#1049-measured--the-ttl-does-not-free-the-lock-and-gkc-ruled-that-an-atserver-defect)
    and [104.10](detail/decisions.md#10410-fixed-in-at_server-the-same-day-and-re-measured-on-the-wire).)
...
21. **`publishOwnRootLink` now costs one extra atServer read per start for a
    ...
    ([decisions 103.5](detail/decisions.md#1035-the-re-anchor-this-forced-which-the-row-did-not-name)),
...
seven are now ruled, in [`decisions.md` 100](detail/decisions.md#100-the-seven-shapes-ruling-99-left-open-2026-08-14),
...
exact shape [98.3](detail/decisions.md#983-where-the-signing-key-comes-from) says must
...
> **RULED 2026-08-15 the same day — [decisions 101](detail/decisions.md#101-the-signing-root-becomes-an-ordinary-signing-key-and-rotatable-2026-08-15).
...
([decisions 18.2](detail/decisions.md#182-custody));
[decisions 46.5](detail/decisions.md#465-the-signing-root-is-the-only-one-way-door)
...
1. **`successor` cannot do the job it was reserved for.** It is stamped `null`
   ...
   [decisions 18.3](detail/decisions.md#183-shape) reserved it for the revocation
...
- **Nothing mints while an advertisement exists.** `NskeySeeding.seed` is
  ...
  session — see [decisions 104.3](detail/decisions.md#1043-two-claims-corrected-in-the-course-of-measuring).
