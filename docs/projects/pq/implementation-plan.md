...
`pqReady` as well — ⚠️ **both halves of that sentence are being changed**: [ruling 138](detail/decisions.md#138-the-posture-ladder-moves-back-a-stage-2026-09-08)
makes at_client 3.x default to `legacy`, and [ruling 137](detail/decisions.md#137-auth_cli-has-two-roles-and-they-take-opposite-postures-2026-09-08) stops auth_cli inheriting the
