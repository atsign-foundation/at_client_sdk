...
void main() {
  ...
  final (opensslPubA, opensslKeyA) = ossl.generateKeypair();
  final (ctA, ssAliceA) = ossl.encapsulate(ossl.importPublicKey(opensslPubA));
  final ssBobA = ossl.decapsulate(opensslKeyA, ctA);
